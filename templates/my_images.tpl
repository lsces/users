		...
		{form enctype="multipart/form-data" legend="Upload personal Portrait, Avatar and Logo"}
			...
			<div class="form-group">
				...
				{if $gQueryUser->mInfo.portrait_attachment_id}
					{forminput}
						<img src="{$gQueryUser->mInfo.portrait_url}?{$smarty.now}" alt="{tr}self portrait{/tr}" /><br />
			...
			<div class="form-group">
				...
				{if $gQueryUser->mInfo.avatar_attachment_id}
					{forminput}
						<img src="{$gQueryUser->mInfo.avatar_url}?{$smarty.now}" alt="{tr}avatar{/tr}" /><br />
			...
			<div class="form-group">
				...
				{if $gQueryUser->mInfo.logo_attachment_id}
					{forminput}
						<img src="{$gQueryUser->mInfo.logo_url}?{$smarty.now}" alt="{tr}logo{/tr}" /><br />
